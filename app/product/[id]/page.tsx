    ...
    return (
      <div className="flex flex-col gap-4 justify-center items-center h-screen font-bold text-gray-500 text-center p-4">
        ...
        <span
          ...
          className="text-2xl sm:text-4xl text-[#074E46]"
        >
          Fetching Product
        </span>
      </div>
    ...
    <>
      ...
      >
        ...
        <section
          ...
          className="bg-[#074E46] text-white rounded-t-4xl flex flex-col-reverse md:flex-row items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 py-8 sm:py-10 md:py-16 mb-10"
        >
          <div className="relative z-10 w-full md:w-1/2 space-y-4 text-center md:text-left">
            ...
            <p
              className="text-white/80 text-sm sm:text-base max-w-md mx-auto md:mx-0"
              style={{ fontFamily: "var(--font-fredoka)" }}
            >
              {product.description}
            </p>
          ...
          <div className="relative z-10 w-full md:w-1/2 flex justify-center mb-8 md:mb-0">
            <Image
              ...
              width={400}
              height={400}
              className="rounded-2xl object-contain bg-white p-4 shadow-lg w-[220px] sm:w-[300px] md:w-[380px] lg:w-[420px] h-auto"
            />
          </div>
        </section>
        ...
        <div className="bg-white rounded-3xl shadow-md p-6 sm:p-8 md:p-10 lg:p-12 max-w-6xl mx-auto space-y-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div>
              ...
              >
                ${product.price}
                <span className="text-sm sm:text-base text-gray-500 font-normal ml-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 text-gray-700">
            ...
            />
            <Detail icon={<Package />} label="Stock" value={`${product.stock} items`} />
            <Detail icon={<Weight />} label="Weight" value={`${product.weight} kg`} />
            <Detail
              icon={<Ruler />}
              label="Dimensions"
        ...
        <motion.div
          ...
          transition={{ duration: 0.4 }}
          className="fixed bottom-0 left-0 w-full bg-white border-t-2 border-gray-300 shadow-xl py-4 sm:py-5 px-4 sm:px-8 md:px-16 flex flex-col xs:flex-row justify-center gap-4 sm:gap-10 items-center z-10"
        >
            ...
            <AnimatePresence mode="wait">
              {quantity === 0 ? (
                <motion.button
                  ...
                  className="bg-[#C7F464] hover:bg-[#b9ec5d] text-[#074E46] px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl font-semibold flex items-center gap-2 text-sm sm:text-base"
                >
                ...
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 10 }}
                  className="flex items-center gap-3 bg-[#F0F4EA] px-4 sm:px-5 py-2 sm:py-3 rounded-xl"
                >
                  <button
                    onClick={decrease}
                    className="bg-[#074E46] text-white rounded-full p-2 sm:p-3"
                  >
                    <Minus size={16} />
                  </button>
                  <motion.span
                    ...
                    className="font-semibold text-gray-700 text-base sm:text-lg w-6 text-center"
                  >
                    {quantity}
                  </motion.span>
                  <button
          ...
          {/* <motion.button
            whileTap={{ scale: 0.95 }}
            className="bg-[#074E46] hover:bg-[#063d38] text-white px-8 sm:px-10 py-2.5 sm:py-3 rounded-xl font-semibold text-sm sm:text-base"
          >
            Buy Now
          </motion.button> */}
        </motion.div>
