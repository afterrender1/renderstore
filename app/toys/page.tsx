...
const toys = [
  ...
  },
  {
    ...
    image: "/images/toys/remotecontrolcar.png",
    price: 29.99,
  ...
  },
  {
    id: "toy-5",
    title: "Toy Train Set",
    image: "/images/toys/trainset.png",
    price: 24.99,
    category: "vehicles",
    description:
  ...
  },
  {
    id: "toy-7",
    title: "Doll House",
    image: "/images/toys/dollhouse.png",
    price: 49.99,
    category: "role play",
    description:
  ...
  },
  {
    ...
    image: "/images/toys/puzzleset.png",
    price: 15.99,
    category: "puzzles",
    description:
  ...
  },
  {
    ...
    image: "/images/toys/kidskeyboard.png",
    price: 34.99,
    category: "music",
    description:
  ...
  return (
    <>
      ...
      <motion.section
        ...
        py-6 xs:py-8 sm:py-10 md:py-16  mx-2 sm:mx-4 md:mx-8 lg:mx-12 xl:mx-18 relative overflow-hidden"
      >
        {/* Left Text Section */}
        <motion.div
          variants={fadeZoomIn}
        ...
        >
          ...
          >
            Discover the <br /> Joy of Playtime
          </h1>
          <p
            className="text-white/80 text-xs xs:text-sm sm:text-base max-w-md mx-auto md:mx-0"
            style={{ fontFamily: "var(--font-fredoka)" }}
          >
            Find toys that spark imagination, learning, and happiness for every
            child.
          </p>
        </motion.div>
